...
{
    public partial class frmBseContrlEdit : frmEditorBase
    {
        ...
        private void DoGvSet()
        {
            if (Convert.ToString(txtClass.EditValue) == string.Empty)
                return;

            frmBseContrlEditGvSet frm = null;
            Form frmEx = StaticFunctions.GetExistedChildForm(this.ParentForm, "frmBseContrlEditGvSet");
            if (frmEx != null)
            {
                frm = frmEx as frmBseContrlEditGvSet;
                frm.SetClass = Convert.ToString(txtClass.EditValue);
                return;
            }
            frm = new frmBseContrlEditGvSet();
            frm.SetClass = Convert.ToString(txtClass.EditValue);
        ...
        private void DoTable()
        {
            ...
            frmBseContrlEditTabel frm = null;
            Form frmEx = StaticFunctions.GetExistedChildForm(this.ParentForm, "frmBseContrlEditTabel");
            if (frmEx != null)
            {
                frm = frmEx as frmBseContrlEditTabel;
                frm.SetClass = Convert.ToString(txtClass.EditValue);
                return;
            }
            frm = new frmBseContrlEditTabel();
            frm.SetClass = Convert.ToString(txtClass.EditValue);
            frm.MdiParent = this.ParentForm;
            frm.FrmEditorBaseP = this;
            frm.Show();
        }
        private void DoSrc(string strSrc)
        {
            if (Convert.ToString(txtClass.EditValue) == string.Empty)
                return;

            frmBseContrlEditSrc frm = null;
            Form frmEx = StaticFunctions.GetExistedChildForm(this.ParentForm, "frmBseContrlEditSrc");
            if (frmEx != null)
            {
                frm = frmEx as frmBseContrlEditSrc;
                frm.SetClass = Convert.ToString(txtClass.EditValue);
                frm.SetClass = strSrc;
                return;
            }
            frm = new frmBseContrlEditSrc();
            frm.SetClass = Convert.ToString(txtClass.EditValue);
            frm.SetClassSrc = strSrc;
            frm.MdiParent = this.ParentForm;
            frm.FrmEditorBaseP = this;
            frm.Show();
        }
        ...
        {
            Form frmEx = StaticFunctions.GetExistedChildForm(this.ParentForm, "frmBseContrlEditAll");
            if (frmEx != null)
            {
                return;
            }
            frmBseContrlEditAll frm = new frmBseContrlEditAll();
            frm.MdiParent = this.ParentForm;
            frm.Show();
        }
    }
